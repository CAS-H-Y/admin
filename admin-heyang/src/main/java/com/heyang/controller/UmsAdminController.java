...
import com.heyang.common.base.CommonResult;
import com.heyang.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @Autowired
    MallStreamClient mallStreamClient;
...
//      String b=a[11];
        //mallStreamClient.input().send(MessageBuilder.withPayload("heyang").build());
        return CommonResult.success("为拦截");
    }
